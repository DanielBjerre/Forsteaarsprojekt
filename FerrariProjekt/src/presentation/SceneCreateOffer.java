	...
	public void init(Stage stage) {
		...
		clmPreviousBalance.setCellValueFactory(cellData -> {
			return new ReadOnlyStringWrapper(
					String.format("%.2f", Double.parseDouble(cellData.getValue().getPreviousBalance())) + "kr");
		});
		clmPayment.setCellValueFactory(cellData -> {
			return new ReadOnlyStringWrapper(
					String.format("%.2f", Double.parseDouble(cellData.getValue().getPayment())) + "kr");
		});
		clmInterest.setCellValueFactory(cellData -> {
			return new ReadOnlyStringWrapper(
					String.format("%.2f", Double.parseDouble(cellData.getValue().getInterest())) + "kr");
		});
		clmPrincipal.setCellValueFactory(cellData -> {
			return new ReadOnlyStringWrapper(
					String.format("%.2f", Double.parseDouble(cellData.getValue().getPrincipal())) + "kr");
		});
		clmNewBalance.setCellValueFactory(cellData -> {
			return new ReadOnlyStringWrapper(
					String.format("%.2f", Double.parseDouble(cellData.getValue().getNewBalance())) + "kr");
		});
		...
		btnCalculate.setOnAction(e -> {
			...
			try {
				...
				lbCustomerNameValue.setText(
						offer.getOfferCustomer().getFirstName() + " " + offer.getOfferCustomer().getLastName());
				...
				lbCustomerAddressValue.setText(offer.getOfferCustomer().getAddress() + " "
						+ offer.getOfferCustomer().getZipCode() + " " + offer.getOfferCustomer().getCity());
				...
				lbEmployeeNameValue.setText(
						offer.getOfferEmployee().getFirstName() + " " + offer.getOfferEmployee().getLastName());
